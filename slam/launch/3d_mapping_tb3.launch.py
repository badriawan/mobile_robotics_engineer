...
def generate_launch_description():
    ...
    selected_robot = os.path.join(robots_dir, 'launch', 'spawn_turtlebot3.launch.py')
    ...
    # ------------------------------
    rviz_config_path = os.path.join(get_package_share_directory('slam'), 'config', '3d_mapping_tb3.rviz')
